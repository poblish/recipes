...
public class NameAdjuster {
	private static final String[]	BAD_PREFIXES = {"beaten", "can", "chilled", "chopped", "coarsely", "cold", "crushed", "dark", "dressed", "dry", "dried", "fresh", "hot", "large", "lean", "plump", "small", "smoked", "tin", "whole"};

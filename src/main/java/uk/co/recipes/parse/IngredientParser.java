...
public class IngredientParser {
	...
	private static final Pattern	A = Pattern.compile( DEC_FRAC_NUMBER_PATTERN + "( ?kg|g|gms| ?pounds?| ?lbs?\\.?| ?oz\\.?|cm|-in|-inch|mm|ml| ?quarts?| cups?| sticks?| heaped tbsps?| tablespoons?| tbsp[s\\.]?| tsp[s\\.]?| teaspoons?| handfuls?| cloves?)? " + SUFFIX, Pattern.CASE_INSENSITIVE);
	...
	private static final Pattern	E = Pattern.compile("((?:dressed|steamed|cooked) [\\w-\\(\\) ]*)" + NOTES, Pattern.CASE_INSENSITIVE);

...
public enum CommonTags implements ITag {
	...
	SUGAR, SALT, FLOUR, BREAD, PASTA, SEED, NUT, PULSE, FRUIT, CITRUS, TROPICAL, CHEESE, BLUE_CHEESE, CHILLI, EGG,

	WINE, ALCOHOL, SPIRIT, VINEGAR, SAUCE, CONDIMENT, SYRUP, RICE, NOODLES, WHEAT, GRAIN, PORRIDGE,

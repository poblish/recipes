...
public class OptionalNameSplittingTest {
	...
	public void testSplitting() {
		...
		assertThat( strFor("Chinese cooking wine", "dry sherry"), is("SplitResults{first=[Chinese cooking wine sherry, Chinese cooking wine], second=[Chinese cooking dry sherry, Chinese dry sherry, dry sherry]}"));
		...
		assertThat( strFor("dried", "fresh kaffir lime leaves"), is("SplitResults{first=[dried kaffir lime leaves, dried lime leaves, dried leaves, dried], second=[fresh kaffir lime leaves]}"));

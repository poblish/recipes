...
public class ParseIngredientsTest {
	...
	public void testSimilarity() throws IOException, IncompatibleIngredientsException {
		...
		assertThat( Categorisation.forIngredients(ingr1).toString(), is("[ALCOHOL, DAIRY, EGG, FAT x 2, FLOUR x 2, FRUIT, HERB x 2, MEAT, OIL, SAUCE, VEGETABLE x 3, WINE]"));
		...
		assertThat( Categorisation.forIngredients(ingrBol1).toString(), is("[ALCOHOL, CHEESE, DAIRY, FAT, HERB, ITALIAN, MEAT x 2, OIL, SUGAR, VEGETABLE x 5, VINEGAR, WINE]"));

...
public class ParseIngredientsTest {
	...
	public void testSimilarity() throws IOException, IncompatibleIngredientsException {
		...
		assertThat( Categorisation.forIngredients(ingr1).toString(), is("[ALCOHOL, CITRUS, DAIRY, EGG, FAT x 2, FISH, FLOUR x 2, FRUIT, HERB x 4, MEAT x 2, OIL, SAUCE, VEGETABLE x 3, WINE]"));
		...
		assertThat( Categorisation.forIngredients(ingr3).toString(), is("[ANISEED, CHILLI, CHINESE, FAT, HERB, INDIAN x 5, MEAT x 2, OIL, POULTRY, SEED, SPICE x 6, STOCK, SUGAR, VEGETABLE x 3]"));
		...
		assertThat( Categorisation.forIngredients(ingrChBeef).toString(), is("[CHILLI, CHINESE x 5, FAT, FLOUR, INDIAN x 2, MEAT x 2, OIL, SAUCE, SPICE x 3, STOCK, SUGAR, THAI, VEGETABLE x 2]"));

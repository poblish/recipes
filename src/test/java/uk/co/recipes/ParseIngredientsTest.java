...
public class ParseIngredientsTest {
	...
	public void parseIngredientsVenisonBurgundy() throws IOException {
		...
		assertThat( allIngredients.toString(), is("[Ingredient{q=3 CUP, item=NamedItem{name=Red Wine, canonical=CanonicalItem{name=Red Wine, tags={WINE=true, ALCOHOL=true}}}, notes={en=[dry]}}, Ingredient{q=2 CUP, item=NamedItem{name=Beef Stock, canonical=CanonicalItem{name=Beef Stock, tags={MEAT=true, SAUCE=true}}}}, Ingredient{q=0 CUP, item=NamedItem{name=Cognac, canonical=CanonicalItem{name=Cognac, parent=CanonicalItem{name=Brandy, tags={WINE=true, ALCOHOL=true, FRENCH=true}}, tags={WINE=true, ALCOHOL=true, FRENCH=true}}}, notes={en=[(or good quality brandy)]}}, Ingredient{q=1, item=NamedItem{name=Onion, canonical=CanonicalItem{name=Onion, tags={VEGETABLE=true}}}, notes={en=[chopped into large pieces, large]}}, Ingredient{q=2, item=NamedItem{name=Carrots, canonical=CanonicalItem{name=Carrots, tags={VEGETABLE=true}}}, notes={en=[peeled and cut into 2-inch-long pieces]}}, Ingredient{q=3, item=NamedItem{name=Garlic, canonical=CanonicalItem{name=Garlic, tags={VEGETABLE=true}}}, notes={en=[crushed and chopped]}}, Ingredient{q=0 CUP, item=NamedItem{name=Parsley, canonical=CanonicalItem{name=Parsley, tags={HERB=true}}}, notes={en=[chopped, fresh]}}, Ingredient{q=1 TSP, item=NamedItem{name=Thyme, canonical=CanonicalItem{name=Thyme, tags={HERB=true}}}, notes={en=[dried]}}, Ingredient{q=1 TSP, item=NamedItem{name=Rosemary, canonical=CanonicalItem{name=Rosemary, tags={HERB=true}}}, notes={en=[dried]}}, Ingredient{q=10, item=NamedItem{name=Black Pepper, canonical=CanonicalItem{name=Black Pepper, parent=CanonicalItem{name=Pepper, tags={SPICE=true}}, tags={SPICE=true}}}}, Ingredient{q=3, item=NamedItem{name=Cloves, canonical=CanonicalItem{name=Cloves, tags={SPICE=true, INDIAN=true}}}, notes={en=[whole]}}, Ingredient{q=1, item=NamedItem{name=Allspice, canonical=CanonicalItem{name=Allspice, tags={SPICE=true}}}}, Ingredient{q=1, item=NamedItem{name=Bay Leaf, canonical=CanonicalItem{name=Bay Leaf, tags={HERB=true}}}, notes={en=[dried]}}, Ingredient{q=3, item=NamedItem{name=pounds venison chuck, canonical=CanonicalItem{name=pounds venison chuck}}, notes={en=[(shoulder cuts), cut into 2-inch chunks]}}, Ingredient{q=0, item=NamedItem{name=Streaky Bacon, canonical=CanonicalItem{name=Streaky Bacon, parent=CanonicalItem{name=Bacon, tags={MEAT=true}}, tags={MEAT=true}}}, notes={en=[cut into thick slices, and then coarsely chopped]}}, Ingredient{q=2 TBSP, item=NamedItem{name=Butter, canonical=CanonicalItem{name=Butter, tags={FAT=true, DAIRY=true}}}}, Ingredient{q=1 TBSP, item=NamedItem{name=Tomato Paste, canonical=CanonicalItem{name=Tomato Paste, parent=CanonicalItem{name=Tomato, tags={VEGETABLE=true}}, tags={VEGETABLE=true}}}}, Ingredient{q=2 TBSP, item=NamedItem{name=Olive Oil, canonical=CanonicalItem{name=Olive Oil, parent=CanonicalItem{name=Vegetable Oil, parent=CanonicalItem{name=Oil, tags={OIL=true, FAT=true}}, tags={OIL=true, FAT=true}}, tags={OIL=true, FAT=true}}}}, Ingredient{q=1, item=NamedItem{name=Onions, canonical=CanonicalItem{name=Onions, tags={VEGETABLE=true}}}, notes={en=[peeled]}}, Ingredient{q=1, item=NamedItem{name=Mushrooms, canonical=CanonicalItem{name=Mushrooms, tags={VEGETABLE=true}}}, notes={en=[wiped clean and bottoms trimmed]}}, Ingredient{q=0 TSP, item=NamedItem{name=Salt, canonical=CanonicalItem{name=Salt, tags={SALT=true}}}}, Ingredient{q=0 TSP, item=NamedItem{name=Black Pepper, canonical=CanonicalItem{name=Black Pepper, parent=CanonicalItem{name=Pepper, tags={SPICE=true}}, tags={SPICE=true}}}}, Ingredient{q=1 TBSP, item=NamedItem{name=Flour, canonical=CanonicalItem{name=Flour, tags={FLOUR=true}}}}]"));
	}

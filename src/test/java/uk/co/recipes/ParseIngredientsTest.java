...
//		assertThat( Similarity.amongIngredients( namings1, namings2), is(1.0));
	...
	public void testSimilarity() throws IOException {
		...
		assertThat( Categorisation.forIngredients(ingr1).toString(), is("[ALCOHOL, BAKING x 2, BRAMBLE_HEDGE, BRINE_SALT, CITRUS, DAIRY, EARTHY, EGG, ENGLISH, FAT x 2, FLOUR x 2, FRUIT, HERB x 4, LEMON, MEAT x 4, OIL, RED_MEAT x 2, SAUCE, STOCK x 2, SULPHUROUS x 2, VEGETABLE x 3, WINE, WOODLAND]"));
		...
		assertThat( Categorisation.forIngredients(ingr4).toString(), is("[ASIAN, CHILLI, CHINESE, CREAMY_FRUITY, EARTHY, FAT, FLORAL_FRUITY, FRUIT, GARLIC, GREEN_GRASSY, INDIAN x 5, MEAT, NUT x 2, OIL, POULTRY, SALT, SPICE x 5, SPICY x 2, SULPHUROUS x 2, THAI, TROPICAL, VEGETABLE x 2, WHITE_MEAT]"));
		...
		assertThat( Categorisation.forIngredients(ingrChBeef).toString(), is("[ALCOHOL x 2, ANISEED, BAKING x 2, CHILLI, CHINESE x 6, CITRUS, FAT, FLOUR, GARLIC, GREEN_GRASSY x 2, INDIAN x 2, MEAT x 2, OIL, RED_MEAT x 2, SAUCE, SPANISH, SPICE x 3, SPIRIT, STOCK, SUGAR, SULPHUROUS x 2, THAI, VEGETABLE x 2, WINE]"));
		...
		assertThat( Categorisation.forIngredients(ingr4, tags).toString(), is("[ASIAN, CHINESE, INDIAN x 5, THAI]"));
    ...
    public void testWeightedCategorisation() throws IOException {
        ...
        assertThat( Categorisation.forIngredientsWeighted(ingrChBeef, natTags).toString(), is("[CHINESE x 9, INDIAN x 4, THAI x 2]"));

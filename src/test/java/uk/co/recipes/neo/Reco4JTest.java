...
public class Reco4JTest {
    ...
    public void testKnn_OurSimilarity() throws IOException {
        ...
        /* basicTest( props, new RecommendationExpectations() {
	...
	private static void basicTest( final Properties inProps, final RecommendationExpectations inExpectations) throws IOException {
        ...
        try {
    		...
    		for (int i = 50; i < 200 && gotNames.size() < 5; i++) {
    			try {
    				...
    				gotRecommendedRatings.add( filterRatings( rec.recommend(node, 10) ) );
    			}

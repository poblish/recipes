...
public class CorrelationsTest {
	...
	public void testCorrelations() throws IOException, IncompatibleIngredientsException, InterruptedException {
		...
		assertThat( withoutTags.toString(), is("[VEGETABLE x 50, MEAT x 32, SPICE x 32, INDIAN x 29, FRUIT x 24, DAIRY x 20, FAT x 17, HERB x 17, ITALIAN x 16, NUT x 15, OIL x 13, SEAFOOD x 13, CITRUS x 11, FISH x 11, BAKING x 9, CHINESE x 9, SAUCE x 9, SUGAR x 9, ALCOHOL x 8, CONDIMENT x 8, POULTRY x 8, PULSE x 8, CHILLI x 7, EGG x 7, THAI x 7, NOODLES x 6, SEED x 6, WINE x 6, CHEESE x 5, FLOUR x 5, PASTA x 5, RICE x 5, VIETNAMESE x 5, MEXICAN x 4, SPANISH x 4, VINEGAR x 4, ANISEED x 3, SALAD_LEAF x 3, STOCK x 3, FLAVOURING x 2, FRENCH x 2, GRAIN x 2, GREEK x 2, JAPANESE x 2, SAUSAGE x 2, WHEAT x 2, GERMAN, HUNGARIAN, OFFAL, SALT]"));
	}

...
public class CorrelationsTest {
	...
	public void testCorrelations() throws IOException, InterruptedException {
		...
		assertThat( withoutTags.toString(), is("[VEGETABLE x 61, BAKING x 39, INDIAN x 39, MEAT x 37, SPICE x 37, FRUIT x 36, DAIRY x 33, ITALIAN x 28, SAUCE x 23, HERB x 22, NUT x 19, FAT x 17, SEAFOOD x 17, SUGAR x 17, ALCOHOL x 14, FISH x 14, CHEESE x 13, OIL x 13, CHINESE x 11, CITRUS x 11, SPIRIT x 11, THAI x 11, FRENCH x 10, SEED x 10, CHILLI x 9, CONDIMENT x 9, PULSE x 9, RICE x 9, POULTRY x 8, EGG x 7, FLOUR x 7, ORANGE x 7, VIETNAMESE x 7, VINEGAR x 7, MEXICAN x 6, NOODLES x 6, PORRIDGE x 6, SPANISH x 6, ALMOND x 5, ANISEED x 5, LEMON x 5, PASTA x 5, SYRUP x 5, JAPANESE x 4, COFFEE x 3, FLAVOURING x 3, GRAIN x 3, GREEK x 3, SALAD_LEAF x 3, STOCK x 3, WINE x 3, BREAD x 2, ENGLISH x 2, HUNGARIAN x 2, SALT x 2, SAUSAGE x 2, SWEET x 2, WHEAT x 2, ASIAN, BLUE_CHEESE, DUTCH, GERMAN, OFFAL, SWISS, USA]"));
	}

...
public class CorrelationsTest {
	...
	public void testCorrelations() throws IOException, InterruptedException {
		...
		assertThat( withoutTags.toString(), is("[VEGETABLE x 62, BAKING x 44, MEAT x 41, INDIAN x 39, FRUIT x 38, SPICE x 37, DAIRY x 35, ITALIAN x 30, HERB x 23, SAUCE x 23, NUT x 19, FAT x 18, SEAFOOD x 18, SUGAR x 17, FISH x 15, ALCOHOL x 14, CHEESE x 14, OIL x 13, CHILLI x 11, CHINESE x 11, CITRUS x 11, FRENCH x 11, SPIRIT x 11, THAI x 11, SEED x 10, CONDIMENT x 9, POULTRY x 9, PULSE x 9, RICE x 9, RED_MEAT x 8, EGG x 7, FLOUR x 7, HEAT_5 x 7, MEXICAN x 7, ORANGE x 7, SCOVILLE x 7, VIETNAMESE x 7, VINEGAR x 7, NOODLES x 6, PORRIDGE x 6, SPANISH x 6, ALMOND x 5, ANISEED x 5, LEMON x 5, PASTA x 5, SYRUP x 5, JAPANESE x 4, COFFEE x 3, FLAVOURING x 3, GRAIN x 3, GREEK x 3, SALAD_LEAF x 3, STOCK x 3, WINE x 3, BREAD x 2, ENGLISH x 2, HUNGARIAN x 2, SALT x 2, SAUSAGE x 2, SWEET x 2, WHEAT x 2, ASIAN, BLUE_CHEESE, CARIBBEAN, DUTCH, GERMAN, OFFAL, SWISS, USA]"));
	}

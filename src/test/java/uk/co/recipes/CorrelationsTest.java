...
public class CorrelationsTest {
	...
	public void testCorrelations() throws IOException, InterruptedException {
		...
		assertThat( withoutTags.toString(), is("[VEGETABLE x 61, MEAT x 36, SPICE x 35, INDIAN x 34, FRUIT x 33, DAIRY x 32, BAKING x 30, ITALIAN x 27, SAUCE x 23, HERB x 22, FAT x 17, SEAFOOD x 17, NUT x 16, FISH x 14, ALCOHOL x 13, CHEESE x 13, OIL x 13, CHINESE x 11, CITRUS x 11, SUGAR x 11, SEED x 10, SPIRIT x 10, CHILLI x 9, FRENCH x 9, PULSE x 9, THAI x 9, CONDIMENT x 8, POULTRY x 8, RICE x 8, EGG x 7, ORANGE x 7, VINEGAR x 7, FLOUR x 6, MEXICAN x 6, NOODLES x 6, SPANISH x 6, LEMON x 5, PASTA x 5, VIETNAMESE x 5, ALMOND x 4, JAPANESE x 4, ANISEED x 3, COFFEE x 3, FLAVOURING x 3, GRAIN x 3, GREEK x 3, SALAD_LEAF x 3, STOCK x 3, WINE x 3, BREAD x 2, ENGLISH x 2, HUNGARIAN x 2, SALT x 2, SAUSAGE x 2, SWEET x 2, WHEAT x 2, BLUE_CHEESE, DUTCH, GERMAN, OFFAL, SWISS]"));
	}

...
public class CorrelationsTest {
	...
	public void testCorrelations() throws IOException, InterruptedException {
        ...
        assertThat( corrs.findCountsWith( itemFactory.get("olive oil").get(), itemFactory.get("Garlic Cloves").get(), itemFactory.get("Onion").get()).toString(),
                    is("[CanonicalItem{name=Bay Leaf, tags={HERB=true}} x 2, CanonicalItem{name=Carrot, tags={VEGETABLE=true}} x 2, CanonicalItem{name=Red Wine, tags={ALCOHOL=true, WINE=true}} x 2, CanonicalItem{name=Chinese five-spice powder, tags={ANISEED=true, CHINESE=true, SPICE=true}}, CanonicalItem{name=Sugar, tags={BAKING=true, SUGAR=true}}, CanonicalItem{name=Braising Beef, parent=CanonicalItem{name=Beef, tags={MEAT=true, RED_MEAT=true}}, tags={MEAT=true, RED_MEAT=true}}, CanonicalItem{name=Allspice, tags={SPICE=true}}, CanonicalItem{name=Cloves, tags={INDIAN=true, SPICE=true}}, CanonicalItem{name=Cognac, parent=CanonicalItem{name=Brandy, tags={ALCOHOL=true, FRENCH=true, SPIRIT=true}}, tags={ALCOHOL=true, FRENCH=true, SPIRIT=true}}, CanonicalItem{name=Pearl Onions, parent=CanonicalItem{name=Onion, tags={VEGETABLE=true}}, tags={VEGETABLE=true}}, CanonicalItem{name=Light Muscovado Sugar, parent=CanonicalItem{name=Brown Sugar, parent=CanonicalItem{name=Sugar, tags={BAKING=true, SUGAR=true}}, tags={BAKING=true, SUGAR=true}}, tags={BAKING=true, SUGAR=true}}, CanonicalItem{name=Yellow Onion, parent=CanonicalItem{name=Onion, tags={VEGETABLE=true}}, tags={VEGETABLE=true}}, CanonicalItem{name=Rosemary, tags={HERB=true}}, CanonicalItem{name=Black Pepper, parent=CanonicalItem{name=Pepper, tags={SPICE=true}}, tags={SPICE=true}}, CanonicalItem{name=Red Wine Vinegar, parent=CanonicalItem{name=Vinegar, tags={VINEGAR=true}}, tags={VINEGAR=true}}, CanonicalItem{name=Beef Stock, tags={MEAT=true, RED_MEAT=true, STOCK=true}}, CanonicalItem{name=steamed bok choi and steamed basmati rice}, CanonicalItem{name=Mixed Herbs, tags={HERB=true}}, CanonicalItem{name=Mushrooms, tags={VEGETABLE=true}}, CanonicalItem{name=Chinese Cooking Wine, tags={ALCOHOL=true, CHINESE=true, WINE=true}}, CanonicalItem{name=Salt, tags={SALT=true}}, CanonicalItem{name=Soy Sauce, tags={CHINESE=true, SAUCE=true}}, CanonicalItem{name=Plain Flour, parent=CanonicalItem{name=Flour, tags={BAKING=true, FLOUR=true}}, tags={BAKING=true, FLOUR=true}}, CanonicalItem{name=Thyme, tags={HERB=true}}, CanonicalItem{name=Minced Beef, parent=CanonicalItem{name=Beef, tags={MEAT=true, RED_MEAT=true}}, tags={MEAT=true, RED_MEAT=true}}, CanonicalItem{name=Dry Sherry, tags={ALCOHOL=true, SPANISH=true, SPIRIT=true}}, CanonicalItem{name=Bacon, tags={MEAT=true}}, CanonicalItem{name=all-purpose flour, tags={FLOUR=true}}, CanonicalItem{name=strong beef stock}, CanonicalItem{name=White Mushrooms, parent=CanonicalItem{name=Mushrooms, tags={VEGETABLE=true}}, tags={VEGETABLE=true}}, CanonicalItem{name=Red Chillies, parent=CanonicalItem{name=Chilli, tags={CHILLI=true}}, tags={CHILLI=true, CHINESE=true, INDIAN=true, THAI=true}}, CanonicalItem{name=venison chuck}, CanonicalItem{name=Ginger, tags={CHINESE=true, INDIAN=true, SPICE=true}}, CanonicalItem{name=Parsley, tags={HERB=true}}, CanonicalItem{name=Star Anise, tags={CHINESE=true, SPICE=true}}, CanonicalItem{name=Spring Onions, parent=CanonicalItem{name=Onion, tags={VEGETABLE=true}}, tags={VEGETABLE=true}}, CanonicalItem{name=Tomato Purée, parent=CanonicalItem{name=Tomato, tags={VEGETABLE=true}}, tags={SAUCE=true, VEGETABLE=true}}, CanonicalItem{name=Bacon Rashers, parent=CanonicalItem{name=Bacon, tags={MEAT=true}}, tags={MEAT=true}}, CanonicalItem{name=Tomato Paste, parent=CanonicalItem{name=Tomato, tags={VEGETABLE=true}}, tags={SAUCE=true, VEGETABLE=true}}, CanonicalItem{name=Parmesan, tags={CHEESE=true, DAIRY=true, ITALIAN=true}}, CanonicalItem{name=Celery, tags={VEGETABLE=true}}]"));
		...
		assertThat( withoutTags.toString(), is("[VEGETABLE x 77, MEAT x 60, BAKING x 46, INDIAN x 42, SPICE x 39, FRUIT x 38, DAIRY x 36, ITALIAN x 31, SAUCE x 28, SEAFOOD x 27, FISH x 24, HERB x 24, NUT x 20, FAT x 19, SUGAR x 18, CHEESE x 16, CHILLI x 16, POULTRY x 15, ALCOHOL x 14, OIL x 14, PULSE x 13, RED_MEAT x 12, THAI x 12, CHINESE x 11, CITRUS x 11, FRENCH x 11, SPIRIT x 11, CONDIMENT x 10, RICE x 10, SEED x 10, ORANGE x 8, VINEGAR x 8, EGG x 7, FLOUR x 7, HEAT_5 x 7, MEXICAN x 7, SCOVILLE x 7, VIETNAMESE x 7, NOODLES x 6, PORRIDGE x 6, SPANISH x 6, ALMOND x 5, ANISEED x 5, ENGLISH x 5, LEMON x 5, PASTA x 5, SYRUP x 5, JAPANESE x 4, BREAD x 3, COFFEE x 3, FLAVOURING x 3, GRAIN x 3, GREEK x 3, LIME x 3, SALAD_LEAF x 3, STOCK x 3, WINE x 3, ASIAN x 2, HUNGARIAN x 2, SALT x 2, SAUSAGE x 2, SWEET x 2, WHEAT x 2, BLUE_CHEESE, CARIBBEAN, DUTCH, GERMAN, OFFAL, SWISS, USA]"));
	}

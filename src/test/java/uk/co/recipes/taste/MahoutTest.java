...
public class MahoutTest {
	...
	public void testItemUserAverageRecommender() throws IOException, TasteException {
		...
		long userId = 1000L;
		assertThat( recommender.recommend(userId++, 10).toString(), is("[RecommendedItem[item:6, value:10.133333], RecommendedItem[item:7, value:9.633333], RecommendedItem[item:5, value:8.133333]]"));
		assertThat( recommender.recommend(userId++, 10).toString(), is("[RecommendedItem[item:7, value:7.883333], RecommendedItem[item:2, value:3.05]]"));
		assertThat( recommender.recommend(userId++, 10).toString(), is("[RecommendedItem[item:5, value:10.133333], RecommendedItem[item:1, value:8.133333], RecommendedItem[item:3, value:6.633333], RecommendedItem[item:4, value:3.6333334]]"));
		assertThat( recommender.recommend(userId++, 10).toString(), is("[RecommendedItem[item:6, value:10.133333], RecommendedItem[item:1, value:6.133333], RecommendedItem[item:3, value:4.633333], RecommendedItem[item:4, value:1.6333333]]"));
